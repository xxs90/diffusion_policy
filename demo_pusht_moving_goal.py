...
from diffusion_policy.env.pusht.pusht_keypoints_moving_goal_env import PushTKeypointsMovingGoalEnv
import pygame
...
def main(output, render_size, control_hz):
    ...
    kp_kwargs = PushTKeypointsMovingGoalEnv.genenerate_keypoint_manager_params()
    env = PushTKeypointsMovingGoalEnv(render_size=render_size, render_action=False, **kp_kwargs)
