...
from diffusion_policy.env.pusht.pusht_env_moving_goal import PushTEnvMovingGoal
from diffusion_policy.env.pusht.pymunk_keypoint_manager import PymunkKeypointManager
import numpy as np

class PushTKeypointsMovingGoalEnv(PushTEnvMovingGoal):
    def __init__(self,
            legacy=False,
            block_cog=None, 
            damping=None,
